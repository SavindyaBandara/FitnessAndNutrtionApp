...
import 'package:fitnessandnutritionapp/view/login/complete_profile_view.dart';
import 'package:fitnessandnutritionapp/view/login/login_view.dart';
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Padding(
          ...
          child: Column(
            children: [
            Text("Hello there", style: TextStyle(color: TColor.grey,fontSize:18 ),
            ),
            ...
            const RoundTextField(hitText: "first name", icon: "assets/images/user_text.png",  ),
